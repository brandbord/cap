...
const VERSION = 'cap-v1.15';
const SHELL = ['./', 'index.html', 'style.css', 'manifest.webmanifest', 'icons/icon-192.png', 'icons/icon-512.png', 'icons/icon-180.png',
  'js/core.js', 'js/ops.js', 'js/autosave.js', 'js/sync.js', 'js/hub.js', 'js/courses.js', 'js/listes.js', 'js/mois.js', 'js/courrier.js', 'js/views-today.js', 'js/views-lists.js', 'js/views-extra.js', 'js/track-core.js', 'js/track-charts.js', 'js/track-evo.js', 'js/track-views.js', 'js/track-evo-view.js', 'js/track-views2.js', 'js/views-misc.js', 'js/app.js'];
